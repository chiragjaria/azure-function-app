...
resource "azurerm_linux_function_app" "func" {
  ...
  # System-assigned identity so it can read AKV
  identity {
    type = "SystemAssigned"
  }
  ...
  app_settings = {
    ...
    # AKV secret references — format: @Microsoft.KeyVault(VaultName=...;SecretName=...)
